...
import com.NakamaMesh.android.noise.southernstorm.protocol.*
 ...
 * 100% compatible with iOS nakamamesh Noise Protocol
 */
class NoiseSession(
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.NakamaMesh.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour
        private const val REKEY_MESSAGE_LIMIT = com.NakamaMesh.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_SESSION // 10k messages
        ...
        private const val MAX_PAYLOAD_SIZE = com.NakamaMesh.android.util.AppConstants.Noise.MAX_PAYLOAD_SIZE_BYTES
        ...
        private const val HIGH_NONCE_WARNING_THRESHOLD = com.NakamaMesh.android.util.AppConstants.Noise.HIGH_NONCE_WARNING_THRESHOLD
